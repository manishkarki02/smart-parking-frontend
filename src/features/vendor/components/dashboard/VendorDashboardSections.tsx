...
import {
  occupancyPercent,
  ratioPercent,
} from "@/features/vendor/utils/vendor-dashboard.utils";
...
export function VendorApprovalBadge({ approved }: { approved: boolean }) {
  return approved ? (
...
export function DashboardKpis({ data }: { data: VendorDashboardData }) {
...
export function VehicleBreakdownCard({
  title,
  subtitle,
  stats,
  icon: Icon,
